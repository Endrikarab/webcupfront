...
import { Button, Container, Title, createStyles, Text } from "@mantine/core";
  ...
  return (
    <>
      <div className="relative w-ful bg-darky">
        <Parallax pages={3} style={{ top: "0", left: "0" }} className="animation bg-darky">

          <ParallaxLayer offset={0} speed={0.1}>
            <div className="animation_layer parallax" id="lanitra"></div>
          </ParallaxLayer>
          <ParallaxLayer offset={0} speed={0.15}>
            <div className="animation_layer parallax" id="nuage">
          ...
          <ParallaxLayer offset={0} speed={0.2}>
            {/* -0.1 */}
            <div className="animation_layer parallax" id="vatobe">
            </div>
          </ParallaxLayer>
          ...
          <ParallaxLayer offset={0} speed={-0.3}>
            {/* 0.35 */}
            <div className="animation_layer parallax mb-[-40vh]" id="volana"></div>
          </ParallaxLayer>
          <ParallaxLayer offset={0} speed={0.50}>
            <div className="relative animation_layer parallax" id="olona"> <div className="w-full h-[40vh] bg-darky absolute bottom-[-40vh]" /></div>
          </ParallaxLayer>

          <ParallaxLayer offset={0} speed={0.24}>
            <div className="animation_layer parallax relative" id="etoiletsyaiko">
              <div>
                <Hero />
              </div>
...
const Hero = () => {
  ...
  return (
    <div className="absolute top-[150px] left-[0] w-full pl-[100px]">
      <Container size="xl" className="top-[150px] left-[0] mx-auto">
